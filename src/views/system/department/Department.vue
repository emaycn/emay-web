      ...
      <el-main>
        <div class="filter-container">
          <el-form :inline="true" class="demo-form-inline">
            <el-form-item>
              <el-input v-model="search" placeholder="请输入部门名称" style="width:260px" />
            </el-form-item>
            <el-form-item label>
            ...
            <el-form-item>
              <el-button v-if="AuthUtils.hasAuth('DEPARTMENT_ADD')" type="primary" icon="el-icon-circle-plus-outline" @click="departmentAdd">新增部门</el-button>
            </el-form-item>
          </el-form>
        </div>
        <el-table
        ...
        >
          ...
          <el-table-column label="操作" align="center" min-width="40%">
            <template slot-scope="{row}">
              <el-button v-if="AuthUtils.hasAuth('DEPARTMENT_MODIFY')" type="primary" size="mini" @click="modify(row)">编辑</el-button>
              <el-button v-if="AuthUtils.hasAuth('DEPARTMENT_DELETE')" size="mini" type="danger" @click="deleteDep(row)">删除</el-button>
              <el-button v-if="AuthUtils.hasAuth('DEPARTMENT_VIEW')" type="success" size="mini" @click="checkstaff(row)">查看人员</el-button>
            </template>
          </el-table-column>
        </el-table>
        <pagination
