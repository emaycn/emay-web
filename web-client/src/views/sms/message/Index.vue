<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="SmsId" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="扩展码" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.extendedCode }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="条数" align="center" width="80">
        <template slot-scope="scope">
