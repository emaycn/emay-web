...
<script>
import { addConfirm } from '@/api/client/role'// 接口
  ...
  methods: {
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        ...
        console.log('submit favourableForm1=' + this.favourableForm.length)
        ...
        if (valid) {
          console.log('submit favourableForm2=' + this.favourableForm.length)
